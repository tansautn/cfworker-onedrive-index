...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'tansautn@hotmail.com',
  ...
  protectedRoutes: ['/xx', /*'/Demo/😎Another Private Folder Password 123'*/],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:e@example.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/tansautn',
    },
  ],
